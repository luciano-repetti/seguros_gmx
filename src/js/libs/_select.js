...
// 					.find(".customSelect-label"),
// 				multiple = that.closest(".customSelect").hasClass("multiple")
// 					? true
// 					: false;
...
// 		$("body").on(
// 			"click tap",
// 			".customSelect input, .customSelect-filter",
// 			function (e) {
// 				e.stopPropagation();
// 			}
// 		);
...
// 					"#" +
// 						that
// 							.closest(".customSelect-tagList")
// 							.attr("id")
// 							.replace("customTags-", "custom-")
// 				),
...
// 			$(
// 				custom.find(".customSelect-options label").get(index)
...
// 				html +=
// 					'<span class="customSelect-tag" data-val="' +
// 					current.val() +
// 					'" data-index="' +
// 					current.index() +
// 					'">' +
...
// 			target = $(
// 				"#customTags-" +
// 					option.closest(".customSelect").find("select")[0].id
// 			);
// 			target.append(html);
// 		}
// 	};
...
// 							item.closest(".customSelect")
// 								.find(".customSelect-options")
// 								.html(options.html);
// 							item.closest(".customSelect")
// 								.find(".customSelect-label")
// 								.html(options.label);
...
// 						'<input type="text" class="customSelect-search noLabel" data-name="" id="auto_' +
// 						'"  autocomplete="off" />' +
// 						"</span>";
// 				}
...
// 				select
// 					.find(".customSelect-options label")
// 					.removeClass("hide active selected");

// 				if (!select.hasClass("multiple")) {
// 					select
// 						.find(".customSelect-options label:first-child")
// 						.trigger("click");
// 				} else {
// 					$(element.find("option")).attr("selected", false);
// 					$("#customTags-" + select.attr("id"))
// 						.find(".customSelect-tag")
// 						.remove();
// 				}
// 			}
// 		},
